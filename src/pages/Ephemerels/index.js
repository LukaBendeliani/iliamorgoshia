...
const Ephemerels = () => {
  return (
    <div className="happiness">
      ...
      <div
        className="vid"
        style={{ width: "30em", transform: "scale(1.3)", margin: "12em" }}
      >
        <img src={ephemerels} alt="ephermals" />
      </div>
      <h3>Ephemerels</h3>
      <div className="role">
      ...
      <div className="cont">
        ...
        <div className="desc">
          <p>
            The path to happiness is a documentary Film. It depicts lifes of
            IDP-s From Abkhazia. The movie mainly shows there activities in a
            adult learning centers , where they develop new skills.
          </p>
        </div>
      </div>
      <div className="cont" style={{ flexDirection: "row-reverse" }}>
        ...
        <div className="desc">
          <p>
            This Film was funded By DVV International. This is an ongoing
            project, wich needed a promo video. Our team did just that.
          </p>
        </div>
      </div>
      <div className="cont">
        ...
        <div className="desc">
          <p>
            It took 1 director, 1 DOP. 2 cameraman, 1 producer, 1 driver and 10
            Weeks to finish this Film. it was an unforgettable journey across
            Georgia.
          </p>
        </div>
      </div>
